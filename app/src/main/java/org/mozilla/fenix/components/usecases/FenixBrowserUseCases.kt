 ...
 * @param searchUseCases [SearchUseCases] retained for compatibility.
...
class FenixBrowserUseCases(
    ...
    private val ao3SearchUrlPrefix =
        "https://archiveofourown.org/works/search?work_search%5Bquery%5D="

    /**
     * Loads a URL or performs an AO3 search depending on the value of [searchTermOrURL].
     *
     * If [searchTermOrURL] is a URL, it is loaded directly.
     * Otherwise, an AO3 search is performed.
     *
     ...
     * @param searchEngine Ignored. AO3 Browser always uses AO3 search.
